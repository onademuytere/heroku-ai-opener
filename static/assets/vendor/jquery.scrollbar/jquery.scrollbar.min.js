    ...
    function h(b) {
        ...
        if (!c.data.outer) {
            ...
            (c.data.inner = a("<div>").css(a.extend({}, d))),
                (c.data.outer = a("<div>")
                    .css(a.extend({ left: "-1000px", overflow: "scroll", position: "absolute", top: "-1000px" }, d))
                    .append(c.data.inner)
                    .appendTo("body"));
        }
    ...
    e.prototype = {
        destroy: function () {
            if (this.wrapper) {
                ...
                this.container.insertBefore(this.wrapper).css({ height: "", margin: "", "max-height": "" }).removeClass("scroll-content scroll-scrollx_visible scroll-scrolly_visible").off(this.namespace).scrollLeft(b).scrollTop(d),
            ...
            if (k) (l = { height: "auto", "margin-bottom": c.scroll.height * -1 + "px", "max-height": "" }), (l[h.isRtl ? "margin-left" : "margin-right"] = c.scroll.width * -1 + "px"), f.css(l);
                ...
                if (
                    ((this.wrapper = k = a("<div>")
                        ...
                        .css("position", "absolute" === e.css("position") ? "absolute" : "relative")
                        .insertBefore(e)
                        .append(e)),
                    h.isRtl && k.addClass("scroll--rtl"),
                    e.is("textarea") && ((this.containerWrapper = f = a("<div>").insertBefore(e).append(e)), k.addClass("scroll-textarea")),
                    (l = { height: "auto", "margin-bottom": c.scroll.height * -1 + "px", "max-height": "" }),
                    ...
                    e.on("scroll" + g, function (b) {
                        ...
                        a.isFunction(h.onScroll) &&
                            h.onScroll.call(d, { maxScroll: i.y.maxScrollOffset, scroll: g, size: i.y.size, visible: i.y.visible }, { maxScroll: i.x.maxScrollOffset, scroll: f, size: i.x.size, visible: i.x.visible }),
            ...
            a.each(i, function (b, f) {
                ...
                f.scroll ||
                    ...
                    (f.mousewheel = function (a) {
                        ...
                        return (
                            c || ("x" === b && a.originalEvent.deltaX ? (c = 40 * a.originalEvent.deltaX) : "y" === b && a.originalEvent.deltaY && (c = 40 * a.originalEvent.deltaY)),
                            ((c > 0 && p < g) || (c < 0 && p > 0)) &&
                                ((p += c),
                                p < 0 && (p = 0),
                                p > g && (p = g),
                ...
                a.each(i, function (b, c) {
                    a.extend(c, "x" == b ? { offset: parseInt(e.css("left"), 10) || 0, size: e.prop("scrollWidth"), visible: k.width() } : { offset: parseInt(e.css("top"), 10) || 0, size: e.prop("scrollHeight"), visible: k.height() });
                }),
        ...
        _getScroll: function (b) {
            ...
            return (
                ...
                a.extend(b, { bar: b.find(".scroll-bar"), size: b.find(".scroll-element_size"), track: b.find(".scroll-element_track") }),
                b
            );
        },
        ...
        _updateScroll: function (b, d) {
            var e = this.container,
                ...
                l = d.visible + i;
            (d.isVisible = k - l > 1),
                d.isVisible ? (d.scroll.addClass(g), h.scroll.addClass(g), f.addClass(g)) : (d.scroll.removeClass(g), h.scroll.removeClass(g), f.removeClass(g)),
                "y" === b && (e.is("textarea") || k < l ? f.css({ height: l + c.scroll.height + "px", "max-height": "none" }) : f.css({ "max-height": l + c.scroll.height + "px" })),
                (d.size == e.prop("scrollWidth") && h.size == e.prop("scrollHeight") && d.visible == j.width() && h.visible == j.height() && d.offset == (parseInt(e.css("left"), 10) || 0) && h.offset == (parseInt(e.css("top"), 10) || 0)) ||
                    (a.extend(this.scrollx, { offset: parseInt(e.css("left"), 10) || 0, size: e.prop("scrollWidth"), visible: j.width() }),
                    a.extend(this.scrolly, { offset: parseInt(e.css("top"), 10) || 0, size: this.container.prop("scrollHeight"), visible: j.height() }),
        ...
        return function (e) {
            ...
            for (f = 0; f < c.scrolls.length; f++)
                (j = c.scrolls[f]),
                    ...
                    (l = j.scrollx),
                    (m = j.scrolly),
                    (e || (i.autoUpdate && k && k.is(":visible") && (h.prop("scrollWidth") != l.size || h.prop("scrollHeight") != m.size || k.width() != l.visible || k.height() != m.visible))) &&
                        (j.init(),
                        i.debug &&
                            (window.console &&
                                console.log(
